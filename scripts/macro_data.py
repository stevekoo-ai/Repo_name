...
PRESETS = {
    ...
    "us_gasoline": ("fred", "GASREGW", "미국 휘발유 전국 평균(정규, 주간, $/gal)", "검증됨(2026-09-25 Actions 백필)"),
    "us_mortgage_30y": ("fred", "MORTGAGE30US", "미국 30년 고정 모기지 금리(프레디맥, 주간)", "검증됨(2026-09-25 Actions 백필)"),
    "us_mich_infl_1y": ("fred", "MICH", "미시간대 1년 기대인플레이션(월간, FRED 공개 약 2개월 지연)", "검증됨(2026-09-25 Actions 백필)"),
    "us_5y5y_infl": ("fred", "T5YIFR", "5년 뒤 5년 기대인플레이션(일별)", "검증됨(2026-09-25 Actions 백필)"),
    "us_tga": ("fred", "WTREGEN", "재무부 일반계정(TGA) 잔고(주간, 백만달러)", "검증됨(2026-09-25 Actions 백필)"),

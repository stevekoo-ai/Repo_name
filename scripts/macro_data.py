...
PRESETS = {
    ...
    "us_sp500": ("fred", "SP500", "S&P 500 지수(일별, ⚠FRED 라이선스로 최근 10년만)", "⚠ 범위 제한 — 2016년 이전은 us_wilshire로 대체"),
    "us_nasdaq": ("fred", "NASDAQCOM", "나스닥 종합지수(일별, 1971~)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    "us_wilshire": ("fred", "WILL5000IND", "윌셔5000 미국주식 전체(일별, 1970~, S&P 장기 대용)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    ...
    "us_2y": ("fred", "DGS2", "미국 2년물 국채금리(일별, 정책기대 반영)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    "us_3m": ("fred", "DGS3MO", "미국 3개월물 국채금리(일별, 달러 현금 기준선)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    ...
    "us_ig_tr": ("fred", "BAMLCC0A0CMTRIV", "미국 우량회사채 총수익지수(ICE BofA)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    "us_hy_tr": ("fred", "BAMLHYH0A0HYM2TRIV", "미국 하이일드채 총수익지수(ICE BofA)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    "us_hy_oas": ("fred", "BAMLH0A0HYM2", "미국 하이일드 스프레드 OAS(위험선호 지표)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    ...
    "us_dollar_index": ("fred", "DTWEXBGS", "달러지수 광의(일별, 2006~)", "⚠ 미검증 — 최초 백필 결과로 확정"),
    "us_dollar_index_major": ("fred", "DTWEXM", "달러지수 주요통화(1973~2020 폐지, 2006년 이전 대용)", "⚠ 미검증 — 최초 백필 결과로 확정"),
}

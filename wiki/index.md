...
- [SK하이닉스](entities/sk-hynix.md) — 반도체 종목; 7/22 종가 1,830,000원(-0.33%), 알파벳 실적 확정(CapEx $205B로 상향되나 주가는 급락 — 체크포인트③ 혼재), 실적발표 7/29 확정(D-6), CXMT 상장 7/27(D-4)·수치정합성 확인, KB증권 420만원 유지 + "AI효율의 역설" 반박논리

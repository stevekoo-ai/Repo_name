...
- [나의 투자 포트폴리오](entities/my-portfolio.md) — 4개 계좌 총 4.5억원(2026-07-13 기준), SK하이닉스가 약 65% 차지하는 집중 포지션; **2026-07-25 KIS API 자동수집 첫 성공(일반 계좌만, ISA/IRP는 API 오류로 미해결·DC는 API 미지원)** — 일반 계좌 SK하이닉스 119주 평가 2.09억원, 제주반도체·롯데렌탈·우리금융지주 소액 보유, 거시국면 대비 유불리 판단 포함

...
- [SK하이닉스](entities/sk-hynix.md) — 반도체 종목; **7/24 종가 1,759,000원(-8.34%) 확정, 6월 ATH(2,987,000) 대비 드로다운 -41.1%로 확대** — 급락 주체는 외국인(순매도 1.76조원)+기관(순매도 8,673억원), 촉발은 알파벳(-7%)·테슬라(-14%) 美 빅테크 실적쇼크의 AI밸류체인 전이+레버리지ETF청산(수급충격, 펀더멘털 훼손 아님). 실적발표 7/29 확정(D-5)·같은날 ADR-본주 양방향 상호전환 개시(체크포인트⑥ 구조적 호재), CXMT 상장 7/27(D-4), 삼성 HBM4 경쟁 격화하나 SK 60%+ 점유율 전망 유지
- [나의 투자 포트폴리오](entities/my-portfolio.md) — 4개 계좌 총 4.5억원(2026-07-13 기준), SK하이닉스가 약 65% 차지하는 집중 포지션; 7/22 SK하이닉스 급반등으로 136주 평가금액 약 2.7~2.8억원 확인(재스냅샷은 아직 필요)
...
- [HBM Cycle Score & 선행지표 조기경보(HSEWS)](concepts/hbm-cycle-score.md) — 외국인수급·보유율·ASP·엔비디아주문&CoWoS·공급확대·고객재고 6축 종합점수(0~100)+투자가설 붕괴조건 4개(0~4) 트래킹; **7/24 하루 최종 확정 70점·경계, 붕괴조건 0/4** — ASP·CoWoS 자체는 견조하나 GB300 개별주문 변동성으로 엔비디아&CoWoS축 소폭 하향, 외국인 등록보유율은 안정적이나 오늘 체결기준 대량매도(1.76조)는 결제시차로 아직 미반영(다음 체크 검증과제)

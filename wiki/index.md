...
- [SK하이닉스](entities/sk-hynix.md) — 반도체 종목; 실적발표일 7/29 공식 확정(6-K), 추정 하향 3개사 트리거 발동 상태, ADR 프리미엄 22.8% 안정 구간; 7/20 장초반 프리장 -7.5%→개장 V반등 +1.2% 롤러코스터, 7/16 종가는 1,842,000원으로 실측 정정

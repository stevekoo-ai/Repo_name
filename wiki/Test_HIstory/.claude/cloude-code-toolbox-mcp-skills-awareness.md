...
_Generated: 2026-08-24T08:20:49.875Z_
...
Workspace `mcp.json` _(folder: Test_HIstory)_

- **c:\Users\2053437\wiki\Test_HIstory\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\2053437\.claude.json** — _File exists — no servers defined_

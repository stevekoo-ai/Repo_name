...
| 2026-07-25 07:10(아침 자동체크, 토요일 휴장) | **70/100**(변동없음) | 경계(60~80) | 0/4 | 외국인수급5·보유율8·ASP20·엔비디아&CoWoS22·공급확대5·고객재고10 — 휴장으로 외국인수급·보유율 갱신 데이터 없음(금요일 값 유지). **엔비디아&CoWoS 재확인**: 엔비디아가 TSMC CoWoS 2026 물량의 50%+(80~85만장) 확보 재확인, CoWoS 완전매진(리드타임 52~78주) 유지, 월생산 12.5~13만장(2026년말 목표) 증설 중 — 어제 하향 근거였던 "GB300 일부 CSP 주문중단"설은 이번 검색에서 재확인되지 않음(미확정 유지, 점수는 보수적으로 22 유지). **고객재고 재확인**: 메타 2026 CapEx $125~145B, MS $190B, 5대 CSP 합산 $660~690B로 기존 낙관 재확인. 붕괴조건 4개 모두 미충족 유지(④는 결제시차 가설 검증 대기 중, 다음 영업일 KSD 보유율 갱신에서 재확인 예정). 별도로 [체크포인트⑥ ADR프리미엄이 41.6~42.9%로 "과열" 구간 진입](sk-hynix-analyst-thesis-checkpoints.md)한 점은 HBM Cycle Score 6축에는 직접 포함 안 되지만 참고할 위험 신호로 병기 |

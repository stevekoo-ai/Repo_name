...
| 2026-07-24 17:20(사용자 차트 확인, 17:33 정정) | 72/100 | 경계(60~80) | 0/4 | 17:20엔 수량차트 판독으로 외국인수급 8→5 하향했으나, 17:33에 사용자가 제공한 외인보유수량 실측(52.60%, 7/22 대비 +0.21%p·+약150만주 순증)으로 **정정** — 외국인은 이탈이 아니라 오히려 보유량 소폭 증가 중. 외국인수급 축은 8→6으로 소폭만 하향(수량차트의 일별 변동성은 인정하되, 보유율 순증이라는 더 신뢰도 높은 신호를 우선 반영). 붕괴조건④(외국인20일순매도전환)도 "근접"에서 "미충족"으로 되돌림 |

...
| 2026-07-24 17:20(사용자 차트 확인) | 70/100 | 경계(60~80) | 0/4(④근접) | 외국인수급 8→5로 하향 조정 — 사용자 제공 차트(증권사 앱 "투자자동향")로 07/02~07/24 누적이 순매도 우위(약 -281,000주), 오늘도 대규모 순매도 재개 확인. 정확한 "20거래일" 경계 수치는 아직 아니라 붕괴조건④는 "충족"이 아닌 "근접"으로 표기. 나머지 5개 축(보유율8·ASP20·엔비디아&CoWoS24·공급확대5·고객재고8)은 오늘 아침 체크 값 유지 |

붕괴조건 ④(외국인 20일 누적 순매도 전환)는 종목별 정밀 일별 수치를 아직
못 구해 미확인 처리였으나, 2026-07-24 17:20 사용자 제공 차트로 방향성은
순매도 쪽에 더 가까워졌음을 확인 — 다음 체크부터 KRX/FnGuide로 정확한
20거래일 경계선 수치 확인 시도.

...
### 1. 🏛️ 정치
- 국정 지지율(approval rating) 추이
- 제네릭 밸럿(공화당 vs 민주당 지지율 격차)
- 당내 결속 vs 이탈 — 공화당 이견 의원 재선 전망, 경선 개입 성과
- 사법 리스크·스캔들
- 개인 리스크(건강·나이 등, 이슈화될 때만)

### 2. 💰 경제
- 체감 물가(CPI, 특히 식료품·에너지)
- 고용지표(실업률, 신규고용)
- 증시 성과(S&P500·다우)
- 관세정책 실질효과 논쟁(물가상승 vs 제조업 고용효과)
- Fed와의 마찰(금리 정책 갈등)
...
### 3. ⚔️ 전쟁/외교
- 중동(이란-이스라엘) 긴장도 — [거시국면 유가 트랙](macro-regime-history.md)과 교차연동
- 우크라이나 전쟁 관련 미국 역할 성과/평가
- 대중국 관계(무역전쟁·대만 등) — SK하이닉스 체크포인트⑦과 접점
- 해외 군사개입 관련 여론(사상자·장기화 피로감)

### 4. 🛂 이민
- 국경 통제 성과 지표(정부 발표 불법입국 건수 등)
- 강경 단속의 부작용(인도적 논란·강제추방 이슈)
- 이민 이슈의 실제 표심 영향(여론조사)

### 5. 🥊 경쟁구도
- 공화당 경선 개입 성과(지지후보 승/패)
- 민주당 전략·후보 경쟁력
- 경합주(swing state)별 판세
- 무당파·중도층 동향

...
- Fed와의 마찰(금리 정책 갈등) — **현재: 7/30 FOMC 매파적 동결(해맥·카시카리·로건 인상 소수의견) — 마찰은 있으나 격화 조짐은 아직 없음**
...
- 대중국 관계(무역전쟁·대만 등) — SK하이닉스 체크포인트⑦과 접점 — **현재: 이번 체크까지 정치적 차원의 신규 이슈 없음**(산업 차원 CXMT 이슈는 SK하이닉스 체크포인트 쪽에서 별도 추적)

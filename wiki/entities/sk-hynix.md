...
7/13 -16.15% 급락 → 7/14 기술적 반등(+11.9%) → 7/15 저항 돌파 + ADR +27% 폭등 → 7/16~20 되돌림 (본주 -4.23%, ADR -13.7%) → **7/20 추가 악재(Kimi K3)로 SOX -20% 베어마켓** → **7/21 미국 반도체주 반발매수 영향으로 +4.08% 반등**(장중 -1.81%→+4.08% 반전). 최저 종가(7/20 1,764,000원) 경신 하루 만에 회복 시작.

- **본주**: 1,836,000원 (전고점 3,002,000원 대비 -38.8%)

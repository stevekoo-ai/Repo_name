...
## 현재 상태 (2026-07-21 아침 기준)

**종가 확정(7/20)**: 1,764,000원(-4.23%, 급락 국면 최저 종가 경신), 코스피 -4.46%(매도 사이드카)

### 최근 사이클 (7/13~7/21)

7/13 -16.15% 급락 → 7/14 기술적 반등(+11.9%) → 7/15 저항 돌파 + ADR +27% 폭등 → 7/16~20 되돌림 (본주 -4.23%, ADR -13.7%) → **7/20 추가 악재(Kimi K3)로 SOX -20% 베어마켓**. 최저 종가 경신 후 리바운드 신호 대기 중(기술적 저점 1,724,000원까지 0.3% 거리).

- **본주**: 1,764,000원 (전고점 3,002,000원 대비 -41.2%, 52주 최저 탐색 중)
- **ADR**: $154.03(7/20 백필 완료), 프리미엄 25% 안정화(정점 52.5%→25%)
...
- **알파벳 실적 임박(7/22, D-1)**: CapEx $180~190B 상향 정당성 검증 필요. 이게 "진짜 수익"으로 이어지는지 미확인.
...
- **③ 빅테크 CapEx (분기점)**: 중립~긍정 유지. 알파벳 CapEx는 확대되지만 "고CapEx→고수익" 정당성이 Kimi K3 충격 아래서 의문 상태. 7/22 실적이 최종 판정.
